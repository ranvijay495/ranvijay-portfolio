...
export const careerData: CareerEntry[] = [
  {
    ...
    year: '2025 - Now',
    hasDualContent: true,
    corporate: `Delivered MPS's <a href="https://www.unboundmedicine.com/news/unbound_medicine_acquired_by_mps_limited" target="_blank" rel="noreferrer">largest-ever acquisition (USD 16.5M)</a>. Spearheaded post-acquisition integration of <a href="https://www.unboundmedicine.com/" target="_blank" rel="noreferrer">Unbound Medicine</a> across Finance, IT, Legal, Business and Operations. Reversed a 40% YoY revenue decline to 8% growth within 5 months for a key B2C subsidiary. Drove EBITDA margin recovery for a business vertical from 18% back toward the 30% benchmark by identifying excess cost items and deploying targeted operational improvement measures.`,
  ...
  },
  {
    ...
    subtitle: 'CGPA 9.65/10 · First in Marine Engineering Courses',
    year: '2014 - 2018',
